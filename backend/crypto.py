...
Uses APP_ENCRYPTION_KEY env var (base64-encoded 32-byte key).
Shared across Salesforce, Nylas Email, and Aircall Dialer integrations.
"""
import os
import base64
import logging
...
def _get_key():
    ...
    if not key_b64:
        raise ValueError(
            "APP_ENCRYPTION_KEY environment variable is required for credential encryption. "
...
def decrypt_token(encrypted: str) -> str:
    ...
    Input: base64-encoded string from encrypt_token().
    """
    from cryptography.hazmat.primitives.ciphers.aead import AESGCM
